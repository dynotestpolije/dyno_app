use super::{DisplayGlyph, DisplayImpl};
    ...
    fn geometry(
        ...
        vec![
            ...
            vec![
                ...
                pos2(                       (segment_thickness / 2.0) + segment_spacing,                       - (segment_thickness / 2.0) - segment_spacing + digit_median),
                pos2(                                                   segment_spacing,                       - (segment_thickness / 2.0) - segment_spacing + digit_median),
                pos2(                                                   segment_spacing,                       - (segment_thickness / 1.0) - segment_spacing + digit_median),
            ],
            vec![
                pos2(-(digit_width / 2.0) + (segment_thickness * 1.5) + segment_spacing,  (digit_height / 2.0) - (segment_thickness / 1.0) - segment_spacing               ),
                pos2(-(digit_width / 2.0) + (segment_thickness / 1.0) + segment_spacing,  (digit_height / 2.0) - (segment_thickness / 1.0) - segment_spacing               ),
