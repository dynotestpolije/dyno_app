use crate::widgets::{
    segment_display::{DisplayDigit, DisplayKind, DisplayMetrics, DisplayMetricsPreset},
    DisplayStyle, DisplayStylePreset,
};
use eframe::egui::{pos2, vec2, Pos2, Response, Sense, Shape, Stroke, Ui, Widget};
use itertools::Itertools;

#[must_use = "You should put this widget in an ui with `ui.add(widget);`"]
pub struct SegmentedDisplay {
...
impl SegmentedDisplay {
    fn new(display_kind: DisplayKind) -> Self {
        Self {
            display_kind,
            digits: Vec::new(),
            digit_height: 80.0,
    ...
    pub fn seven_segment<S: AsRef<str>>(value: S) -> Self {
        Self::new(DisplayKind::SevenSegment).push_string(value)
    }

    pub fn nine_segment<S: AsRef<str>>(value: S) -> Self {
        Self::new(DisplayKind::NineSegment).push_string(value)
    }

    pub fn sixteen_segment<S: AsRef<str>>(value: S) -> Self {
...
impl Widget for SegmentedDisplay {
