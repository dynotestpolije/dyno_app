...
use eframe::egui::{
    ...
    vec2, Align2, Color32, FontFamily, FontId, Rect, Response, Sense, Stroke, Ui, Widget,
};

use barcoders::{
    error::Error,
    sym::{
        codabar::Codabar, code11::Code11, code128::Code128, code39::Code39, code93::Code93,
        ean13::EAN13, ean8::EAN8, ean_supp::EANSUPP, tf::TF,
    },
};
...
pub enum BarcodeKind {
    ...
    #[display(fmt = "Code 39 (+checksum)")]
    Code39Checksum,

    #[display(fmt = "Code 93")]
    Code93,

    #[display(fmt = "Code 128")]
    Code128,
    ...
    #[display(fmt = "Supplemental EAN")]
    EANSUPP,

    #[display(fmt = "Interleaved 2 of 5")]
    ITF,

    #[display(fmt = "Standard 2 of 5")]
    STF,
}
