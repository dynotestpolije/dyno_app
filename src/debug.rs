...
use dynotest_app::widgets::{button::ButtonExt, DynoWidgets};
...
impl DebugAction {
    ...
    pub fn draw(
        ...
        eframe::egui::Window::new("Debug Window").show(ctx, |ui| {
            ...
            eframe::egui::Grid::new("my_grid")
                ...
                .show(ui, |ui| {
                    ...
                    if ui.reset_button().clicked() {
                        super::log::debug!("Resetting Buffer in debug emulation");
                        buffer.clean();
                    }
